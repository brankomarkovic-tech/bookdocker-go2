...
export const InstagramIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.012 3.584-.07 4.85c-.148 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.584-.012-4.85-.07c-3.252-.148-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.85s.012-3.584.07-4.85c.148-3.225 1.664-4.771 4.919-4.919C8.416 2.175 8.796 2.163 12 2.163zm0 1.441c-3.193 0-3.56.012-4.788.069-2.928.134-4.215 1.422-4.35 4.35C2.8 9.212 2.788 9.59 2.788 12s.012 2.788.069 4.012c.134 2.928 1.422 4.215 4.35 4.35 1.228.056 1.595.069 4.788.069s3.56-.012 4.788-.069c2.928-.134 4.215-1.422 4.35-4.35.057-1.228.069-1.595.069-4.788s-.012-3.56-.069-4.788c-.134-2.928-1.422-4.215-4.35-4.35C15.56 3.615 15.193 3.604 12 3.604z" />
        <path d="M12 6.865A5.135 5.135 0 1 0 17.135 12 5.135 5.135 0 0 0 12 6.865zm0 8.27A3.135 3.135 0 1 1 15.135 12 3.135 3.135 0 0 1 12 15.135z" />
        <circle cx="17.5" cy="6.5" r="1.24" />
    </svg>
);
...
export const ShieldCheckIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944A11.955 11.955 0 0112 21.056a11.955 11.955 0 019-10.056c0-1.317-.252-2.584-.714-3.792z" />
    </svg>
);
...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path transform="translate(0, -0.5)" strokeLinecap="round" strokeLinejoin="round" d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
        <g stroke="none" fill="currentColor">
            <circle cx="17.0" cy="5.1" r="1.2" />
            <circle cx="20.1" cy="14.6" r="1.2" />
            <circle cx="12" cy="20.5" r="1.2" />
            <circle cx="3.9" cy="14.6" r="1.2" />
            <circle cx="7.0" cy="5.1" r="1.2" />
        </g>
    </svg>
);
...
export const OnLeaveIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const HoneycombIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <g transform="rotate(45 12 12)">
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 3.5 L16 5.75 L16 10.25 L12 12.5 L8 10.25 L8 5.75 Z" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M8 10.25 L12 12.5 L12 17 L8 19.25 L4 17 L4 12.5 Z" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M16 10.25 L20 12.5 L20 17 L16 19.25 L12 17 L12 12.5 Z" />
        </g>
    </svg>
);
